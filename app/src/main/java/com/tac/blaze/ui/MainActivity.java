...
import com.tac.blaze.adapters.ChatroomRecyclerAdapter;
import com.tac.blaze.models.Chatroom;
import com.tac.blaze.models.User;
import com.tac.blaze.models.UserLocation;
import com.tac.blaze.services.LocationService;
...
import static com.tac.blaze.Constants.ERROR_DIALOG_REQUEST;
import static com.tac.blaze.Constants.PERMISSIONS_REQUEST_ACCESS_FINE_LOCATION;
import static com.tac.blaze.Constants.PERMISSIONS_REQUEST_ENABLE_GPS;
...
//        this.startService(serviceIntent);
    ...
    private boolean isLocationServiceRunning() {
        ...
        for (ActivityManager.RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)){
            if("com.tac.googledirectionstest.services.LocationService".equals(service.service.getClassName())) {
